"""Django production settings for digital_msharika project."""
...
ALLOWED_HOSTS = ["kkktdmp.com", "www.kkktdmp.com", "127.0.0.1", "localhost"]
...
# Media files (uploaded/downloaded assets)
MEDIA_URL = "/media/"
